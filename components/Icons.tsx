...
export const LightbulbIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9 18h6a2 2 0 0 1 2 2v1H7v-1a2 2 0 0 1 2-2z"></path>
    <path d="M5.6 6.6a9 9 0 1 1 12.8 0"></path>
...
export const SparklesIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2.69l5.74 5.74L12 14.17 6.26 8.43 12 2.69zM12 2.69l-5.74 5.74L12 14.17l5.74-5.74L12 2.69z"></path>
    <path d="M17 17l5-5-5-5"></path>
    <path d="M7 7L2 12l5 5"></path>
  </svg>
);
